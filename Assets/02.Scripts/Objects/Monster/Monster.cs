...
public class Monster : ObjectBase
{
    ...
    #region Animation hashing Fields
    ...
    ********************************************/
    ...
    protected override void LoadData()
    {
        ...
        {
            Debug.Assert(_monsterData != null, "MonData is NULL!!");
            return;
        }
    ...
    /// <summary> drop 될 아이템의 정보 초기화 </summary>
    protected void InitDropItemData()
    {
    ...
    /// <summary> NavMesh 추격 비활성화 </summary>
    ...
    ********************************************/
    ...
    private IEnumerator ObjectAction()
    {
        while (!m_bisDead)
        {
            switch (objState)
    ...
    /// <summary> 활성 / 비활성화 타이머</summary>
    private IEnumerator SetActive(bool value, float time)
    {
        yield return new WaitForSeconds(time);
        transform.gameObject.SetActive(value);
    }
    /// <summary> 활성화, 비활성화 여부에 따른 현재 오브젝트의 불투명도 </summary>
    private IEnumerator ActiveAlphaValue(bool value)
    {
